...
const TOAST_CONFIG = {
  success: {
    bgClass: "bg-bg-elevated border-l-4 border-success",
    iconClass: "text-success",
    textClass: "text-success",
    icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />',
  },
  error: {
    bgClass: "bg-bg-elevated border-l-4 border-error",
    iconClass: "text-error",
    textClass: "text-error",
    icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" />',
  },
  warning: {
    bgClass: "bg-bg-elevated border-l-4 border-warning",
    iconClass: "text-warning",
    textClass: "text-warning",
    icon: '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />',
  },
  info: {
    bgClass: "bg-bg-elevated border-l-4 border-primary",
...
function showToast(message, type = "success", duration = 3000) {
  ...
  toast.className = `${config.bgClass} rounded-lg p-4 flex items-center max-w-md transition-all duration-300`;
  toast.innerHTML = `
